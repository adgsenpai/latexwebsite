...
const settings = {
  ...
  siteUrl: (siteUrl = process.env.SHARELATEX_SITE_URL || 'http://latex.adgstudios.co.za'),

  // The name this is used to describe your ShareLaTeX Installation
  appName: process.env.SHARELATEX_APP_NAME || 'LaTeX @ ADGSTUDIOS)',
  ...
  adminEmail: process.env.SHARELATEX_ADMIN_EMAIL || 'adg@adgstudios.co.za',
